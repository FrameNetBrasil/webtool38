...
class RelationTypeController extends MController
{
    ...
    public function formNewRelationType()
    {
        ...
        $this->data->save = "@admin/relationtype/newRelationType|formNewRelationType";
    ...
    public function formUpdateRelationType()
    {
        ...
        $this->data->save = "@admin/relationtype/updateRelationType|formUpdateRelationType";
    ...
    public function newRelationType()
    {
        try {
            ...
            $model->save();
            return $this->renderPrompt('information', 'OK', "structure.editEntry('{$this->data->relationtype->entry}');");
        } catch (\Exception $e) {
