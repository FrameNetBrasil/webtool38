...
class MainController extends MController
{
    ...
    public function layersData()
    {
        ...
        return $this->renderJson($this->data->layersData);
    }
    ...
    public function validation()
    {
        try {
            ...
            return $this->renderPrompt('information', 'ok', "!annotation.showSubCorpus(annotation.idSubCorpus)");
        } catch (\Exception $e) {
    ...
    public function putLayers()
    {
        try {
            ...
            //return $this->renderPrompt('information', 'ok', $action);
            return $this->render();
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    ...
    public function addFELayer()
    {
        ...
        return $this->renderJSON(json_encode($layer));
    }
    ...
    public function getFELabels()
    {
        ...
        return $this->renderJSON(json_encode($labels));
    }
