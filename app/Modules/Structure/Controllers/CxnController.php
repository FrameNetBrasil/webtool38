...
class CxnController extends MController
{
    ...
    public function formDeleteCxn()
    {
        ...
        return $this->renderPrompt('confirmation', 'Atenção: A Cxn e todos os CxnElements serão removidos! Continua?', $ok);
    }
    ...
    public function formDeleteCxnElement()
    {
        ...
        return $this->renderPrompt('confirmation', 'Atenção: O CxnElement será removido! Continua?', $ok);
    }
    ...
    public function newCxn()
    {
        try {
            ...
            return $this->renderPrompt('ok', 'Construction created.');
        } catch (\Exception $e) {
    ...
    public function updateCxn()
    {
        try {
            ...
            $model->save($this->data->cxn);
            return $this->renderPrompt('information', 'OK',"structure.reloadCxnParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    }
    ...
    public function deleteCxn() {
        try {
            ...
            return $this->renderPrompt('information', 'Cxn deleted.',"structure.reloadCxn();");
        } catch (\Exception $e) {
            ddump($e->getMessage());
            return $this->renderPrompt('error', "Não é possível remover esta construção.");
        }
    ...
    public function deleteCxnElement() {
        try {
            ...
            return $this->renderPrompt('information', 'CxnElement deleted.',"!structure.reloadCxnParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', "Não é possível remover este elemento.");
        }
    ...
    public function formDeleteRelation()
    {
        ...
        return $this->renderPrompt('confirmation', 'Warning: Relation will be deleted! Continue?', $ok);
    }
    ...
    public function addConstraintCX() {
        ...
        try {
            ...
            return $this->renderPrompt('error', "Add Constraint failed." . $e->getMessage());
        }
    }
    ...
    public function deleteConstraint() {
        try {
            ...
            $model->delete();
            return $this->renderPrompt('information', 'Constraint deleted.', "!structure.reloadCxnParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', "Delete Constraint failed.","!structure.reloadCxn();");
        }
    }
    ...
    public function deleteRelation() {
        try {
            ...
            return $this->renderPrompt('information', 'Relation deleted.', "!structure.reloadCxnParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', "Delete Relation failed.","!structure.reloadCxn();");
        }
    }
