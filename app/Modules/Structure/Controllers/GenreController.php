...
class GenreController extends MController
{
    ...
    public function newGenreType()
    {
        try {
            ...
            return $this->renderPrompt('information', 'OK', "structure.editEntry('{$this->data->genretype->entry}');");
        } catch (\Exception $e) {
    ...
    public function newGenre()
    {
        try {
            ...
            return $this->renderPrompt('information', 'OK', "structure.editEntry('{$this->data->genre->entry}');");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    }
    ...
    public function formDeleteGenre()
    {
        ...
        return $this->renderPrompt('confirmation', 'Warning: Genre will be deleted! Continue?', $ok);
    }
    ...
    public function deleteGenree()
    {
        try {
            $model = new fnbr\models\Genre($this->data->id);
            $model->delete();
            return $this->renderPrompt('information', 'Genre deleted.', "!structure.reloadParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    }
