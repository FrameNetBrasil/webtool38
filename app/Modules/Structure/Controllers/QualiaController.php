...
class QualiaController extends MController
{
    ...
    public function newQualia()
    {
        try {
            ...
            return $this->renderPrompt('ok', 'Qualia created.',"!$('#formQualia_dialog').dialog('close');");
        } catch (\Exception $e) {
    ...
    public function formDeleteQualia()
    {
        ...
        return $this->renderPrompt('confirmation', 'Atenção: A estrutura qualia será removida! Continua?', $ok);
    }
    ...
    public function deleteQualia()
    {
        try {
            ...
            $model->delete();
            return $this->renderPrompt('information', 'OK', "!structure.reloadParent();");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    ...
    public function formLUQualiaFormal()
    {
        ...
        return $this->render('formLUQualia');
    }
    ...
    public function newLUQualia()
    {
        try {
            ...
            //return $this->renderPrompt('ok', 'Qualia Relation created.',"!$('#formLUQualia_dialog').dialog('close');");
            return $this->renderPrompt('ok', 'Qualia Relation created.');
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    }
    ...
    public function formDeleteQualiaRelation()
    {
        ...
        return $this->renderPrompt('confirmation', 'Atenção: A relação qualia será removida! Continua?', $ok);
    }
