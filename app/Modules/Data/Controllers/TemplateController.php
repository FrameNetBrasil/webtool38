...
/*
    ...
    public function formDelete() {
        ...
        return $this->renderPrompt('confirmation', "Confirma remoção do Template [{$model->getDescription()}] ?", $ok, $cancelar);
    }
    ...
    public function delete() {
            ...
            return $this->renderPrompt('information',"Template [{$this->data->idTemplate}] removido.", $go);
    }
*/
}