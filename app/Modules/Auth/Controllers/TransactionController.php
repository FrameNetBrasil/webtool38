...
class TransactionController extends MController {
    ...
    public function formDelete() {
        ...
        return $this->renderPrompt('confirmation', "Confirma remoção do Transaction [{$model->getDescription()}] ?", $ok, $cancelar);
    }
    ...
    public function delete() {
            ...
            return $this->renderPrompt('information',"Transaction [{$this->data->idTransaction}] removido.", $go);
    }
