...
class LogController extends MController {
    ...
    public function formDelete() {
        ...
        return $this->renderPrompt('confirmation', "Confirma remoção do Log [{$model->getDescription()}] ?", $ok, $cancelar);
    }
    ...
    public function delete() {
            ...
            return $this->renderPrompt('information',"Log [{$this->data->idLog}] removido.", $go);
    }
