...
class MessageBoxController extends MController {
    ...
    public function formDelete() {
        ...
        return $this->renderPrompt('confirmation', "Confirma remoção do Auth_messagebox [{$model->getDescription()}] ?", $ok, $cancelar);
    }
    ...
    public function delete() {
            ...
            return $this->renderPrompt('information',"Auth_messagebox [{$this->data->idMessageBox}] removido.", $go);
    }
