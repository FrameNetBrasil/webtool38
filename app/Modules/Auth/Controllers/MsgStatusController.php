...
class MsgStatusController extends MController {
    ...
    public function formDelete() {
        ...
        return $this->renderPrompt('confirmation', "Confirma remoção do Auth_msgstatus [{$model->getDescription()}] ?", $ok, $cancelar);
    }
    ...
    public function delete() {
            ...
            return $this->renderPrompt('information',"Auth_msgstatus [{$this->data->idMsgStatus}] removido.", $go);
    }
