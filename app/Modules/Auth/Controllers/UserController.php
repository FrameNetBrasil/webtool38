...
class UserController extends MController
{
    ...
    public function statusList()
    {
        ...
        return $this->renderJson(json_encode($statusList));
    }
    ...
    public function formResetPassword()
    {
        ...
        return $this->renderPrompt('question', _M("Confirm password reset?"), $yes, "");
    }
    ...
    public function save()
    {
        try {
            ...
            return $this->renderPrompt('information', 'OK', "jQuery('#gf_LU').datagrid('reload');");
        } catch (\Exception $e) {
    ...
    public function authorize()
    {
        try {
            ...
            $user->setStatus('1');
            $user->save();
            return $this->renderPrompt('information', "User [{$user->getLogin()}] is now authorized.");
        } catch (\Exception $e) {
            return $this->renderPrompt('error', $e->getMessage());
        }
    }
    ...
    public function getConstraintsLU()
    {
        ...
        return $this->renderJson(json_encode($r));
    }
