...
class FrameElement extends Repository
{
    ...
    public function create($data)
    {
        ...
        try {
            $baseEntry = 'fe_' . $data->nameEn . '_' . $data->idFrame;
            $entity = new Entity();
            ...
            Timeline::addTimeline("frameelement", $id, "S");
            $this->commit();
        } catch (\Exception $e) {
            $this->rollback();
            ddump($e->getMessage());
    ...
    public function listInternalRelations(int $idFrame)
    {
        $idLanguage = AppService::getCurrentIdLanguage();
        $result = RelationModel::getCriteria()
