...
HERE;
        ...
        $constraints = $this->query($cmd);
        foreach ($constraints as $i => $constraint) {
            $constraints[$i]['prefix'] = $constraint['prefix'] . '_' . $constraints[$i]['name'];
            $constraints[$i]['name'] = $constraint['name'];
            ...
            $constraints[$i]['relationName'] = $constraint['relationName'];
            $constraints[$i]['idConstraint'] = $constraint['idConstraint'];
            $constraints[$i]['idEntityRelation'] = $constraint['idConstraintInstance'];
        }
        return $constraints;
    }
