...
return [
    ...
    'actions' => [
        'admin' => ['Admin', '/admin', 'construction', 'ADMIN', 1, [
            'user' => ['Users', '/users', 'edit', 'ADMIN', 1, []],
            'group' => ['Groups', '/groups', 'edit', 'ADMIN', 1, []],
            'type' => ['Types', '/types', 'edit', 'ADMIN', 1, []],
            'relation' => ['Relations', '/relations', 'edit', 'ADMIN', 1, []],
            'genre' => ['Genres', '/genres', 'edit', 'ADMIN', 1, []],
            'layer' => ['Layers', '/layers', 'edit', 'ADMIN', 1, []],
            'constraint' => ['Constraints', '/constraints', 'edit', 'ADMIN', 1, []],
        ]],
