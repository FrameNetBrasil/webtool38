...
(function ($) {
    ...
    $.notify = {
        ...
        tip: function (msg) {
            ...
            _14 = $.extend({}, $.notify.defaults, {
                content: "<div class=\"" + cls + "\"></div>" + "<div style=\"white-space:nowrap\">" + _14.msg + "</div>" + "<div style=\"clear:both;\"></div>",
                border: false,
                noheader: true,
                modal: false,
                title: null,
        ...
        prompt: function (_1b, msg, fn) {
            ...
            _1c = $.extend({}, $.notify.defaults, {content: "<div class=\"messager-icon messager-question\"></div>" + "<div>" + _1c.msg + "</div>" + "<br>" + "<div style=\"clear:both;\"></div>" + "<div><input class=\"messager-input\" type=\"text\"></div>"}, _1c);
            if (!_1c.buttons) {
                _1c.buttons = [{
                    text: _1c.ok, onClick: function () {
        ...
        progress: function (_1d) {
            ...
            var dlg = _d($.extend({}, $.messager.defaults, {
                content: "<div class=\"messager-progress\"><div class=\"messager-p-msg\">" + _20.msg + "</div><div class=\"messager-p-bar\"></div></div>",
                closable: false,
                doSize: false
            }, _20, {
                onClose: function () {
                    ...
                    if (_1d.onClose) {
                        ...
                        $.notify.defaults.onClose.call(this);
                    }
                }
            }));
